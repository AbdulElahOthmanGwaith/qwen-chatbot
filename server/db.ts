...
import { InsertUser, conversations, messages, users } from "../drizzle/schema";
...
// Conversations
export async function createConversation(userId: number, title: string = "New Conversation") {
  const db = await getDb();
  ...
  // Get the last inserted conversation
